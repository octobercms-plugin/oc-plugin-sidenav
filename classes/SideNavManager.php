<?php namespace Jcc\Sidenav\Classes;
...
class SideNavManager
{
    ...
    protected function loadItems()
    {
        ...
        foreach ($plugins as $id => $plugin) {
            if(method_exists($plugin,'registerSideNavSettings')){
                $items = $plugin->registerSideNavSettings();
                if (!is_array($items)) {
                    continue;
                }
        ...
        /**
         * @event system.sideNav.extendItems
         * Provides an opportunity to manipulate the system settings manager
         *
         * Example usage:
         *
         *     Event::listen('system.sideNav.extendItems', function ((\System\Classes\SideNavManager) $sideNavManager) {
         *         $sideNavManager->addSettingItem(...)
         *         $sideNavManager->removeSettingItem(...)
         *     });
         *
         */
        Event::fire('system.sideNav.extendItems', [$this]);
        if(!$this->items){
            $this->items= [];
        }
        /*
...
//        dd($items);
    ...
    {
//        dd($this->contextItemCode,$this->contextOwner);
        return (object) [
